...
class PostModelTest(TestCase):
    ...
    def test_post_creation(self):
        ...
        self.assertEqual(self.post.reading_time, 1)  # Default reading time for short content
    ...
    def test_reading_time_calculation(self):
        ...
        self.post.save()
        self.assertEqual(self.post.reading_time, 2)  # 400 words / 200 words per minute = 2 minutes
